...
_TOOL_RESPONSES: dict[str, dict[str, str]] = {
    ...
    "book_success": {
        "en":    "Your appointment has been booked for {date} at {time}. You will receive a WhatsApp confirmation shortly.",
        "ta":    "உங்கள் அப்பாயின்மெண்ட் {date} அன்று {time} மணிக்கு பதிவு செய்யப்பட்டது. வாட்ஸ்அப்பில் உறுதிப்படுத்தல் அனுப்பப்படும்.",
        "hi":    "आपका अपॉइंटमेंट {date} को {time} बजे बुक हो गया। WhatsApp पर कन्फर्मेशन मिलेगी।",
        "ta-mix": "Unga appointment {date} anaikku {time}-la book aachu. WhatsApp-la confirmation varum.",
        "hi-mix": "Aapka appointment {date} ko {time} baje book ho gaya. WhatsApp par confirmation milegi.",
    },
    "reschedule_success": {
        "en":    "Your appointment has been rescheduled to {new_date} at {new_time}. A WhatsApp confirmation is on its way.",
        "ta":    "உங்கள் அப்பாயின்மெண்ட் {new_date} அன்று {new_time} மணிக்கு மாற்றப்பட்டது. வாட்ஸ்அப்பில் தெரிவிக்கப்படும்.",
        "hi":    "आपका अपॉइंटमेंट {new_date} को {new_time} बजे रीशेड्यूल हो गया। WhatsApp पर सूचित किया जाएगा.",
        "ta-mix": "Unga appointment {new_date} anaikku {new_time}-la reschedule aachu. WhatsApp-la solluvaanga.",
        "hi-mix": "Aapka appointment {new_date} ko {new_time} baje reschedule ho gaya. WhatsApp par bataya jayega.",
    },
    "cancel_success": {
        "en":    "Your appointment has been successfully cancelled.",
        "ta":    "உங்கள் அப்பாயின்மெண்ட் வெற்றிகரமாக ரத்து செய்யப்பட்டது.",
        "hi":    "आपका अपॉइंटमेंट सफलतापूर्वक रद्द कर दिया गया है.",
        "ta-mix": "Unga appointment cancel aachu.",
        "hi-mix": "Aapka appointment cancel ho gaya.",
    },
    "no_appointments": {
